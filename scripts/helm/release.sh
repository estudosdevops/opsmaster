...
show_help() {
    ...
    echo
    echo "Uso: opsmaster helm release <ação> <release> [ambiente]"
    echo
    echo "Ações:"
    ...
    echo
    echo "Exemplos:"
    echo "  opsmaster helm release list"
    echo "  opsmaster helm release diff my-app"
    echo "  opsmaster helm release apply my-app prod"
    echo
}
